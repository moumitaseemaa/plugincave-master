      ...
      if (item.dataset.view) {
        ...
        if (pluginName === "counterup") {
          ...
          function progressbar() {
            ...
            barStartPoint = barStartPoint - 0.1;
            if (pluginPercentMove === "true") {
              item.style.position = "relative";
              item.innerHTML = `<div class="percentages" style="position:absolute;right:0;top:0;">${parseInt(
                barStartPoint
              )}%</div>`;
            } else {
              item.innerHTML = `<div class="percentages">${parseInt(
                barStartPoint
              )}%</div>`;
            }
